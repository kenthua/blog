...
Very bad / slow wireguard performance. If you recall, this particulat setup was for handling cgnat's and not being able to port forward. My performance was in the 10-20kbits/sec. I had to set my mtu to `1400`. The default is `1420`
